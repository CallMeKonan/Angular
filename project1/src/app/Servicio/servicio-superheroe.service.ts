...
export class ServicioSuperheroeService {
  ...
  private listaSuperheroes=new BehaviorSubject<SuperHero[]>([]);
  readonly heroes=this.listaSuperheroes.asObservable(); 

  private arrayHeroes:SuperHero[];
